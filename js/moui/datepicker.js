...
define('moui/datepicker', ['jquery'], function($) {
    ...
    (function() {
            var scriptFiles = doc.getElementsByTagName('script'),
    ...
    function parseUILanguage() {
            var languageTag = doc.getElementsByTagName('html')[0].getAttribute('lang') || doc.getElementsByTagName('html')[0].getAttribute('xml:lang');
    ...
    function datePicker(options) {
            ...
            this.isIE7               = doc.documentElement && typeof doc.documentElement.style.maxHeight != "undefined";
            @end
            @*/
            ...
            this.getScrollOffsets = function() {
                    if(typeof(host.pageYOffset) == 'number') {
                            //Netscape compliant
                            return [host.pageXOffset, host.pageYOffset];
            ...
            this.reposition = function() {
                    ...
                    var osh         = o.div.offsetHeight,
                        ...
                        elem        = doc.getElementById('fd-but-' + o.id),
                        pos         = o.truePosition(elem),
                        trueBody    = (doc.compatMode && doc.compatMode!="BackCompat") ? doc.documentElement : doc.body,
            ...
            this.removeOldFocus = function() {
                    var td = doc.getElementById(o.id + "-date-picker-hover");
                    if(td) {
                            try {
                                    setTabIndex(td, -1);
            ...
            this.addAccessibleDate = function() {
                    ...
                    if(td && !(td.getElementsByTagName("span").length)) {
                            ...
                            if(noS) {
                                    ...
                                    spnC.appendChild(doc.createTextNode(getTitleTranslation(13)));
                                    td.appendChild(spnC);
                            };
                            ...
                            for(var pt = 0, part; part = formatParts[pt]; pt++) {
                                    ...
                                    if(part == "%j" || part == "%d") {
                                            td.appendChild(doc.createTextNode(printFormattedDate(new Date(ymd[1], +ymd[2]-1, ymd[3]), part, true)));
                                    } else {
                                            spnC = spn.cloneNode(false);
                                            spnC.appendChild(doc.createTextNode(printFormattedDate(new Date(ymd[1], +ymd[2]-1, ymd[3]), part, true)));
                                            td.appendChild(spnC);
                                    };
                            };
                    };
            ...
            this.updateTable = function(noCallback) {
                    ...
                    for(var curr = 0; curr < 42; curr++) {
                            ...
                            if((curr > firstColIndex && curr <= (firstColIndex + dpm)) || o.fillGrid) {
                                    ...
                                    if(o.rangeLow && +currentDate < +o.rangeLow || o.rangeHigh && +currentDate > +o.rangeHigh) {
                                            ...
                                            td.appendChild(doc.createTextNode(dt));
                            ...
                            if(o.showWeeks && curr - (row * 7) == 6) {
                                    ...
                                    o.wkThs[row].appendChild(doc.createTextNode(cellAdded[row] == 4 && !o.fillGrid ? nbsp : getWeekNumber(cy, cm, curr - firstColIndex - 6)));
                    ...
                    span[0].appendChild(doc.createTextNode(getMonthTranslation(cm, false) + nbsp));
                    span[1].appendChild(doc.createTextNode(cy));
                    ...
                    if(o.timerSet) {
                            ...
                            o.timer = host.setTimeout(o.updateTable, o.timerInc);
                    };
            ...
            this.destroy = function() {
                    ...
                    if(doc.getElementById("fd-but-" + this.id)) {
                            doc.getElementById("fd-but-" + this.id).parentNode.removeChild(doc.getElementById("fd-but-" + this.id));
                    };
                    ...
                    removeEvent(doc, "mousedown", o.onmousedown);
                    removeEvent(doc, "mouseup",   o.clearTimer);

                    if (host.addEventListener && !host.devicePixelRatio) {
                            try {
                                    host.removeEventListener('DOMMouseScroll', this.onmousewheel, false);
                            } catch(err) {};
                    } else {
                            removeEvent(doc, "mousewheel", this.onmousewheel);
                            removeEvent(host,   "mousewheel", this.onmousewheel);
                    };
            ...
            this.create = function() {
                    ...
                    if(doc.getElementById("fd-" + this.id)) {
                            return;
                    };
                    ...
                    function createThAndButton(tr, obj) {
                            for(var i = 0, details; details = obj[i]; i++) {
                                    ...
                                    tr.appendChild(th);
                                    var but = doc.createElement('span');
                                    but.className = details.className;
                                    but.id = o.id + details.id;
                                    but.appendChild(doc.createTextNode(details.text || o.nbsp));
                    ...
                    if(this.describedBy && doc.getElementById(this.describedBy)) {
                    ...
                    if(!this.staticPos) {
                            ...
                            doc.getElementsByTagName('body')[0].appendChild(this.div);

                            /*@cc_on
                            @if(@_jscript_version <= 5.7)

                            if(!this.isIE7) {
                                    this.iePopUp = doc.createElement('iframe');
                        ...
                        setARIARole(this.iePopUp, "presentation");
                                    ...
                                    doc.body.appendChild(this.iePopUp);
                            };
                            ...
                            elem = doc.getElementById(this.positioned ? this.positioned : this.id);
                            if(!elem) {
                                    this.div = null;
                                    if(debug) {
                    ...
                    if(this.statusFormat) {
                            tableFoot = doc.createElement('tfoot');
                    ...
                    tableHead = doc.createElement('thead');
                    ...
                    span.appendChild(doc.createTextNode(nbsp));
                    ...
                    for (var y = 0; y < colspanTotal; y++) {
                            if(y == 0 && this.showWeeks) {
                                    this.ths[y].appendChild(doc.createTextNode(getTitleTranslation(6)));
                                    this.ths[y].title = getTitleTranslation(8);
                                    continue;
                            };

                            if(y > (this.showWeeks ? 0 : -1)) {
                                    but = doc.createElement("span");
                    ...
                    this.butPrevYear     = doc.getElementById(this.id + "-prev-year-but");
                    this.butPrevMonth    = doc.getElementById(this.id + "-prev-month-but");
                    this.butToday        = doc.getElementById(this.id + "-today-but");
                    this.butNextYear     = doc.getElementById(this.id + "-next-year-but");
                    this.butNextMonth    = doc.getElementById(this.id + "-next-month-but");
            ...
            this.fade = function() {
                    host.clearTimeout(o.fadeTimer);
                    o.fadeTimer = null;
                    var diff = Math.round(o.opacity + ((o.opacityTo - o.opacity) / 4));
                    o.setOpacity(diff);
                    if(Math.abs(o.opacityTo - diff) > 3 && !o.noFadeEffect) {
                            o.fadeTimer = host.setTimeout(o.fade, 50);
                    } else {
            ...
            this.stopDrag = function(e) {
                    ...
                    removeEvent(doc,'mousemove',o.trackDrag, false);
                    removeEvent(doc,'mouseup',o.stopDrag, false);
            ...
            this.onmousedown = function(e) {
                    ...
                    if(origEl.id.search(new RegExp("^" + o.id + "(-prev-year-but|-prev-month-but|-next-month-but|-next-year-but)$")) != -1) {
                            ...
                            addEvent(doc, "mouseup", o.clearTimer);
                            ...
                            addEvent(doc,'mousemove',o.trackDrag, false);
                            addEvent(doc,'mouseup',o.stopDrag, false);
                            addClass(doc.getElementsByTagName("body")[0], "fd-drag-active");
            ...
            this.show = function(autoFocus) {
                    ...
                    for(elemID in this.formElements) {
                            elem = doc.getElementById(this.id);
                    ...
                    if(!this.created || !doc.getElementById('fd-' + this.id)) {
                            this.created    = false;
                            this.fullCreate = false;
                            this.create();
                    ...
                    if(this.noFocus) {
                            ...
                            addEvent(doc, "mousedown", this.onmousedown);
                            if(mouseWheel) {
                                    if (host.addEventListener && !host.devicePixelRatio) {
                                            host.addEventListener('DOMMouseScroll', this.onmousewheel, false);
                                    } else {
                                            addEvent(doc, "mousewheel", this.onmousewheel);
                                            addEvent(host,   "mousewheel", this.onmousewheel);
                                    };
                            };
                    } else {
                            this.clickActivated = false;
                    ...
                    this.setNewFocus();
                    this.fade();
                    var butt = doc.getElementById('fd-but-' + this.id);
                    if(butt) {
                              addClass(butt, "date-picker-button-active");
                    };
            };
            this.hide = function() {
                    if(!this.visible || !this.created || !doc.getElementById('fd-' + this.id)) {
                            return;
                    };
                    ...
                    removeEvent(doc, "mousedown", this.onmousedown);
            ...
            this.onmousewheel = function(e) {
                    ...
                    if (e.wheelDelta) {
                            ...
                            if (isOpera && host.opera.version() < 9.2) {
                                    delta = -delta;
                            };
                    } else if(e.detail) {
                            delta = -e.detail/3;
    ...
    datePicker.prototype.createButton = function() {
            ...
            if(this.staticPos || doc.getElementById("fd-but-" + this.id)) {
                    return;
            };

            var inp         = doc.getElementById(this.id),
                span        = doc.createElement('span'),
                but         = doc.createElement('a');
            ...
            span.appendChild(doc.createTextNode(but.title));
            but.appendChild(span);
            ...
            if(this.positioned && doc.getElementById(this.positioned)) {
                    doc.getElementById(this.positioned).appendChild(but);
            } else {
    ...
    datePicker.prototype.addOnFocusEvents = function() {
            ...
            addEvent(doc, "keypress", this.onkeydown);
            addEvent(doc, "mousedown", this.onmousedown);

            /*@cc_on
            @if(@_win32)
            removeEvent(doc, "keypress", this.onkeydown);
            addEvent(doc, "keydown", this.onkeydown);
            @end
            @*/
            if(host.devicePixelRatio) {
                    removeEvent(doc, "keypress", this.onkeydown);
                    addEvent(doc, "keydown", this.onkeydown);
            };
            this.noFocus = false;
    ...
    datePicker.prototype.removeOnFocusEvents = function() {
            ...
            removeEvent(doc, "keypress",  this.onkeydown);
            removeEvent(doc, "keydown",   this.onkeydown);
            removeEvent(doc, "mousedown", this.onmousedown);
    ...
    datePicker.prototype.truePosition = function(element) {
            ...
            var iebody      = (doc.compatMode && doc.compatMode != "BackCompat")? doc.documentElement : doc.body,
                dsocleft    = doc.all ? iebody.scrollLeft : host.pageXOffset,
                dsoctop     = doc.all ? iebody.scrollTop  : host.pageYOffset,
    ...
    datePicker.prototype.updateStatus = function(msg) {
            ...
            if(msg && this.statusFormat.search(/%S/) != -1 && msg.search(/([0-9]{1,2})(st|nd|rd|th)/) != -1) {
                    ...
                    var dc = doc.createDocumentFragment();
                    for(var i = 0, nd; nd = msg[i]; i++) {
                            if(/^(st|nd|rd|th)$/.test(nd)) {
                                    var sup = doc.createElement("sup");
                                    sup.appendChild(doc.createTextNode(nd));
                                    dc.appendChild(sup);
                            } else {
                                    dc.appendChild(doc.createTextNode(nd));
                            };
                    };
                    this.statusBar.appendChild(dc);
            } else {
                    this.statusBar.appendChild(doc.createTextNode(msg ? msg : getTitleTranslation(9)));
            };
    };
    ...
    datePicker.prototype.setDateFromInput = function() {
            var origDateSet = this.dateSet,
                m           = false,
                but         = this.staticPos ? false : doc.getElementById("fd-but-" + this.id),
    ...
    datePicker.prototype.returnFormattedDate = function(noFocus) {
            var but = this.staticPos ? false : doc.getElementById("fd-but-" + this.id);
    ...
    datePicker.prototype.disableDatePicker = function() {
            ...
            if(this.staticPos) {
                    ...
                    removeEvent(doc, "mousedown", this.onmousedown);
                    removeEvent(doc, "mouseup",   this.clearTimer);
            } else {
                    if(this.visible) {
                            this.hide();
                    };
                    var but = doc.getElementById("fd-but-" + this.id);
                    if(but) {
    ...
    datePicker.prototype.updateTableHeaders = function() {
            ...
            for(var col = colOffset; col < colspanTotal; col++ ) {
                    ...
                    if(col > colOffset) {
                            ...
                            but.appendChild(doc.createTextNode(getDayTranslation(d, true)));
                            ...
                            this.ths[col].appendChild(doc.createTextNode(getDayTranslation(d, true)));
                    };
    ...
    var destroy = function(e) {
            ...
            removeEvent(host, 'unload', datepicker.destroy);
    };
    ...
    var updateLanguage = function() {
            if(typeof(host.fdLocale) == "object" ) {
                    localeImport = {
    ...
    var addDatePicker = function(options) {
            ...
            opts = {
                    ...
                    positioned:options.positioned && doc.getElementById(options.positioned) ? options.positioned : "",
                    ...
                    describedBy:(options.describedBy && doc.getElementById(options.describedBy)) ? options.describedBy : describedBy && doc.getElementById(describedBy) ? describedBy : "",
                    // Callback functions
    ...
    addEvent(host, 'unload', destroy);
    addEvent(host, "load", function() { setTimeout(updateStatic, 0); });

    // Add oldie class if needed for IE < 9
    /*@cc_on
    @if (@_jscript_version < 5.8)
            addClass(doc.documentElement, "oldie-mhtml");
    @end
    @if (@_jscript_version < 9)
            addClass(doc.documentElement, "oldie");
    @end
    @*/
